...
acs_tracts_boulevard = acs_data_la %>%
...
locations_sf = tribble(
  ...
  "Harold A Henry Park", -118.326204, 34.05771, boulevard,
  "MacArthur Park", -118.277825, 34.059539, boulevard,
  #"Los Angeles Elementary School", -118.30564277817867, 34.04767415795226, boulevard,
  #"Los Angeles High School", -118.33290205238154, 34.05631575779619,  boulevard,
  "Normandie Recreation Center", -118.299765, 34.044543, boulevard
  ) %>%
...
plot_acs_maps(
  ...
  save = TRUE,
  outpath = file.path(file_path, area, "Outputs"),
  file_extension = ".png")
```
