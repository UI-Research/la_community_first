...
```{r}
boulevard = "hoover" ## SET THIS TO THE STUDY AREA YOU ARE INTERESTED IN; MUST MATCH FOLDER NAME EXACTLY
...
hla_all_city <- st_read(file.path(file_path, "raw_data/Measure HLA Vote/HLA.shp")) %>% 
      st_make_valid() %>%
