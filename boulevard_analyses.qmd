...
map2 = 
    ...
    tm_shape(samo_limits) +
      tm_polygons(fill = "darkgrey", fill_alpha = .5, col = "black", lwd = .5) +
    tm_shape(
...
tmap_save(map2, file = here(file_path, boulevard, "Outputs", "study_area_map.png"), height = 5, width = 6.75, dpi = 2000)
...
commute_age_combined <- commute_mode_age_boulevard %>% 
  ...
  mutate(area = factor(area, levels = c("Ohio Ave", "LA City")))
