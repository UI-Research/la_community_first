...
```{r}
boulevard = "Pico"
boulevard_tracts = file.path(file_path, "Data", "Mapping", "Boulevards", boulevard, str_c(boulevard, "_buffer_tracts.shp")) %>%
  st_read(quiet = TRUE)
```
...
Plotting comparison charts (Teddy)
...
-   Figure 7 (employment status – partly complete)

-   Figure 8 (gender)

-   Figure 9 (household structure)

-   Figure 10 (speak english well)

-   Figure 11 (other languages)

-   Figure 20 (Internet and device access)

-   Figure 21 (housing tenure)

-   Figure 29 (commute mode)

-   Figure 30 (commute time)
...
streets_sf = tribble(
  ...
  "Crenshaw Blvd",  34.0304238641463, -118.33551198275727, 90, "Pico",
  "Arlington Ave",  34.03130279886178, -118.31775449166764, 90, "Pico",
  "Western Ave", 34.03064831048125, -118.30907566457537, 90, "Pico",
  "Normandie Ave", 34.03140186970061, -118.30027509279961, 90, "Pico",
...
plot_acs_maps(
  ...
  locations_sf = pico_locations_sf,
